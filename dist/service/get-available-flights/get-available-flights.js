...
exports.getAvailableFlights = void 0;
const getAvailableFlights = ({ origin, destination, departureDateTime, }) => __awaiter(void 0, void 0, void 0, function* () {
    return fetch(`https://interline.tudoazul.com/catalog/api/v1/availability?&tripType=ONE_WAY&origin=${origin}&destination=${destination}&adult=1&child=0&infant=0&typeOfFlight=ALL&companiesIdentity=-&cabinCategory=ECONOMY&departureDateTime=${departureDateTime}T00:00:00-03:00`, {
        headers: {
...
exports.getAvailableFlights = getAvailableFlights;
